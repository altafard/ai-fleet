...
func newRoot(code *int) *cobra.Command {
	...
	f.StringVar(&o.Model, "model", "", "claude model for the run, alias or full ID (required)")
	f.StringVar(&o.Effort, "effort", "", "claude reasoning effort: low|medium|high|xhigh|max (required)")
